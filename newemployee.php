...
<div class="container-fluid">
	...
	<form action ="" method="POST">
			...
			<div class="form-group">
					<input type="text" class ="form-control" id="salary1" name="salary1" Placeholder="Enter Salary">
				</div>
			<div class="form-group">
				<input type="text" class ="form-control" id="tds1" name="tdsamount1" Placeholder="Enter Tds Amount">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
					<input type="text" class ="form-control" id="salary2" name="salary2" Placeholder="Enter Salary">
				</div>
			<div class="form-group">
				<input type="text" class ="form-control" id="tds2" name="tdsamount2" Placeholder="Enter Tds Amount">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
					<input type="text" class ="form-control" id="salary3" name="salary3" Placeholder="Enter Salary">
			</div>
			<div class="form-group">
				<input type="text" class ="form-control" id="tds3" name="tdsamount3" Placeholder="Enter Tds Amount">
			</div>
