...
if(isset($_GET['edit'])) {
$id = $_GET['edit'];
$sql = "SELECT * From `admincreate` WHERE `id` = '".$id."' ";
...
while($row = mysqli_fetch_assoc($query)){
 ...
 if(isset($_POST['submit'])){
   ...
   $sql1 = "UPDATE `admincreate` SET `organization`='".$neworganization."' ,`username`='".$newname."' ,`email`='".$newmail."' , `password`='".$newpassword."' ,`number`='".$newnumber."' WHERE `id` = '".$id."' ";
